    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (all == 1){
                    ...
                    sql = "SELECT * FROM vehicules WHERE date = '" + date + "'";
                }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.Rows.Count != 0)
            {
                ...
                sb.AppendLine("<center><b>Nouveau Sinistre : </b></center><br>");
                ...
                foreach (DataGridViewRow rowView in dataGridView1.Rows)
                {
                    ...
                    string decodedStringHTML = decodedString.Replace("%20", " ");
                    sb.AppendLine("<tr><td align='center' valign='middle'>" + num + "</td><td align='center' valign='middle'>" + bus + "</td><td align='center' valign='middle'>" + decodedStringHTML + "</td><td align='center' valign='middle'>" + controleur + "</td><td align='center' valign='middle'>" + date + "</td><td align='center' valign='middle'>" + Heure + "</td></tr>");
                }
